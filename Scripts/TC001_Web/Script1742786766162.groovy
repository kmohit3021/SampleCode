...
WebUI.setText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/input_Username_username'), GlobalVariable.username)
...
WebUI.click(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/td_26'))
...
WebUI.verifyElementText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 
    'Appointment Confirmation')

WebUI.verifyElementText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/p_Please be informed that your appointment _11813a'), 
